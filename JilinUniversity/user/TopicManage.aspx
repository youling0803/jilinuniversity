    ...
    <form id="Form" runat="server" method="post">
        <div class="tab-content table_num">
            ...
            <div class="functionbtn">
                <span>
                    <button type="button" class="btn btn-primary btnpos" runat="server" id="add" onchange="jump(this);" onserverclick="NewAddAntiDetection">
                        新增课题申请
                ...
                <asp:GridView ID="GridViewDetection" runat="server" AllowPaging="True" AutoGenerateColumns="False" Width="100%" PageSize="5" Font-Size="10pt" CssClass="mGrid"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="批复机时">
                            <ItemTemplate>
                                <asp:Label ID="LabelApprovedTime" Text='<%# Eval("ApprovedTime")%>' runat="server" CssClass="mlength2"></asp:Label>
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Center" />
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="到期日">
                            <ItemTemplate>
                                <asp:Label ID="LabelEndDate" Text='<%# Bind("EndDate","{0:yyyy/MM/dd}")%>' runat="server" CssClass="mlength"></asp:Label>
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Center" />
                        </asp:TemplateField>
