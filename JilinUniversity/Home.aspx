...
<body>
    <form id="form1" runat="server">
        <div class="logo3">
            <div style="margin: 1px auto; width: 300px;">
                <img src="image/title2.png" style="width: 400px;" />
            </div>
            <a href="Login.aspx" class="rightup" style="color: black">退出登录
            </a>
        </div>
        <div>
            <aside id="box_left">
                <div class="picture">              
                <img src="image/use.jpg" style="width: 80%; height: 80%;margin-left:10%;" />
